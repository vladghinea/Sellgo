...
const ClientForm = () => {
  return <form className="row g-3">
                <div className="col-md-6">
                    ...
                    <input type="text" className="form-control" id="clientFirstName" placeholder="John" />
                </div>
                <div className="col-md-6">
                    <label htmlFor="clientLastName" className="form-label">Last Name</label>
                    <input type="text" className="form-control" id="clientLastName" placeholder="Doe" />
                </div>
                <div className="col-6">
                    <label htmlFor="clientCompany" className="form-label">Company</label>
                    <input type="text" className="form-control" id="clientCompany" placeholder="ExonMobile" />
                </div>
                <div className="col-6">
                    <label htmlFor="clientPosition" className="form-label">Position</label>
                    <input type="text" className="form-control" id="clientPosition" placeholder="Marketing Manager" />
                </div>
                <div className="col-6">
                    <label htmlFor="clientEmail" className="form-label">Email</label>
                    <input type="email" className="form-control" id="clientEmail" placeholder="john.doe@exemple.com" />
                </div>
                <div className="col-6">
                    <label htmlFor="clientPhone" className="form-label">Phone</label>
                    <input type="tel" className="form-control" id="clientPhone" placeholder="+40 0700 261 291" />
                </div>
                <div className="col-3">
                ...
                <div className="col-6">
                    <h3>Personal</h3>
                    <button className='btn btn-info'>Add Approach</button>
                </div>
                <div className="col-6">
                    <h3>Profesional</h3>
                    <button className='btn btn-info'>Add Approach</button>
